...
[![Steam Community Market median sale prices for P250 Cartel](https://github.com/Oscar514444/so-engine/releases/download/graph-screenshots-2026-09/steam-market-history-p250-cartel-month.png)](https://github.com/Oscar514444/so-engine/releases/download/graph-screenshots-2026-09/steam-market-history-p250-cartel-month.png)
...
[![Steam Market graphs and SO Engine lower-peak annotations](https://github.com/Oscar514444/so-engine/releases/download/graph-screenshots-2026-09/steam-market-graphs-lower-peaks-contact-sheet.png)](https://github.com/Oscar514444/so-engine/releases/download/graph-screenshots-2026-09/steam-market-graphs-lower-peaks-contact-sheet.png)

[Open the large lower-peak zoom PNG](https://github.com/Oscar514444/so-engine/releases/download/graph-screenshots-2026-09/steam-buy-order-lower-peaks-p250-zoom.png)

### P250 | Cartel — walls detected and crossed

[![SO Engine catches lower buy-order peaks for P250 Cartel](https://github.com/Oscar514444/so-engine/releases/download/graph-screenshots-2026-09/steam-buy-order-graph-p250-cartel-field-tested-annotated.png)](https://github.com/Oscar514444/so-engine/releases/download/graph-screenshots-2026-09/steam-buy-order-graph-p250-cartel-field-tested-annotated.png)
...
[![SO Engine band-bottom fallback for MP9 Hydra](https://github.com/Oscar514444/so-engine/releases/download/graph-screenshots-2026-09/steam-buy-order-graph-mp9-hydra-battle-scarred-annotated.png)](https://github.com/Oscar514444/so-engine/releases/download/graph-screenshots-2026-09/steam-buy-order-graph-mp9-hydra-battle-scarred-annotated.png)
